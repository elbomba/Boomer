...
<form id="upload" action="<?php echo base_url(); ?>adds-on/loader/audio-file-loader.php" method="post" enctype="multipart/form-data">
    
    <div class="edit-line">
	<div class="label">
	    <label for="file">File: </label>
	</div>
        <input type="file" name="file[]" id="file" accept="audio/*" multiple /><br>
    </div>
